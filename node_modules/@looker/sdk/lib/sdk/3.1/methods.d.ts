...
export declare class Looker31SDK extends APIMethods {
    ...
    all_homepages(fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IHomepage[], IError>>;
    ...
    all_spaces(fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISpaceBase[], IError>>;
    ...
    create_homepage(body: Partial<IWriteHomepage>, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IHomepage, IValidationError | IError>>;
    create_homepage_item(body: Partial<IWriteHomepageItem>, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IHomepageItem, IValidationError | IError>>;
    create_homepage_section(body: Partial<IWriteHomepageSection>, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IHomepageSection, IValidationError | IError>>;
    ...
    create_space(body: Partial<ICreateSpace>, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISpace, IValidationError | IError>>;
    ...
    datagroup(datagroup_id: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IDatagroup, IError>>;
    ...
    delete_homepage(homepage_id: number, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<string, IError>>;
    delete_homepage_item(homepage_item_id: number, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<string, IError>>;
    delete_homepage_section(homepage_section_id: number, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<string, IError>>;
    ...
    delete_space(space_id: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<string, IError>>;
    ...
    homepage(homepage_id: number, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IHomepage, IError>>;
    homepage_item(homepage_item_id: number, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IHomepageItem, IError>>;
    homepage_section(homepage_section_id: number, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IHomepageSection, IError>>;
    ...
    legacy_feature(legacy_feature_id: number, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ILegacyFeature, IError>>;
    ...
    space(space_id: string, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISpace, IError>>;
    space_ancestors(space_id: string, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISpace[], IError>>;
    ...
    space_dashboards(space_id: string, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IDashboard[], IError>>;
    space_looks(space_id: string, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ILookWithQuery[], IError>>;
    space_parent(space_id: string, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISpace, IError>>;
    ...
    theme(theme_id: string, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ITheme, IError>>;
    ...
    update_backup_configuration(body: Partial<IWriteBackupConfiguration>, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IBackupConfiguration, IValidationError | IError>>;
    ...
    update_content_metadata_access(content_metadata_access_id: number, body: Partial<IContentMetaGroupUser>, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IContentMetaGroupUser, IValidationError | IError>>;
    ...
    update_datagroup(datagroup_id: string, body: Partial<IWriteDatagroup>, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IDatagroup, IValidationError | IError>>;
    ...
    update_homepage(homepage_id: number, body: Partial<IWriteHomepage>, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IHomepage, IValidationError | IError>>;
    update_homepage_item(homepage_item_id: number, body: Partial<IWriteHomepageItem>, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IHomepageItem, IValidationError | IError>>;
    update_homepage_section(homepage_section_id: number, body: Partial<IWriteHomepageSection>, fields?: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IHomepageSection, IValidationError | IError>>;
    ...
    update_legacy_feature(legacy_feature_id: number, body: Partial<IWriteLegacyFeature>, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ILegacyFeature, IValidationError | IError>>;
    ...
    update_space(space_id: string, body: Partial<IUpdateSpace>, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ISpace, IValidationError | IError>>;
    update_theme(theme_id: string, body: Partial<IWriteTheme>, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ITheme, IValidationError | IError>>;
