...
class Looker40SDK extends apiMethods_1.APIMethods {
    constructor(authSession) {
        super(authSession, '4.0');
        this.stream = new streams_1.Looker40SDKStream(authSession);
    }
    ...
    async all_board_items(request, options) {
    ...
    async all_board_sections(request, options) {
        return this.get('/board_sections', { fields: request.fields, sorts: request.sorts }, null, options);
    }
    async all_boards(fields, options) {
        return this.get('/boards', { fields }, null, options);
    }
    ...
    async board(board_id, fields, options) {
        return this.get(`/boards/${board_id}`, { fields }, null, options);
    }
    async board_item(board_item_id, fields, options) {
        return this.get(`/board_items/${board_item_id}`, { fields }, null, options);
    }
    async board_section(board_section_id, fields, options) {
        return this.get(`/board_sections/${board_section_id}`, { fields }, null, options);
    }
    ...
    async create_board(body, fields, options) {
        return this.post('/boards', { fields }, body, options);
    }
    async create_board_item(body, fields, options) {
        return this.post('/board_items', { fields }, body, options);
    }
    async create_board_section(body, fields, options) {
        return this.post('/board_sections', { fields }, body, options);
    }
    ...
    async create_embed_url_as_me(body, options) {
        return this.post('/embed/token_url/me', null, body, options);
    }
    ...
    async delete_board(board_id, options) {
        return this.delete(`/boards/${board_id}`, null, null, options);
    }
    async delete_board_item(board_item_id, options) {
        return this.delete(`/board_items/${board_item_id}`, null, null, options);
    }
    async delete_board_section(board_section_id, options) {
        return this.delete(`/board_sections/${board_section_id}`, null, null, options);
    }
    ...
    async search_boards(request, options) {
    ...
    async update_board(board_id, body, fields, options) {
        return this.patch(`/boards/${board_id}`, { fields }, body, options);
    }
    async update_board_item(board_item_id, body, fields, options) {
        return this.patch(`/board_items/${board_item_id}`, { fields }, body, options);
    }
    async update_board_section(board_section_id, body, fields, options) {
        return this.patch(`/board_sections/${board_section_id}`, { fields }, body, options);
    }
