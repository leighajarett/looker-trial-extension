...
class Looker40SDKStream extends apiMethods_1.APIMethods {
    ...
    async all_board_items(callback, request, options) {
        return this.authStream(callback, 'GET', '/board_items', {
            fields: request.fields,
            sorts: request.sorts,
            board_section_id: request.board_section_id,
        }, null, options);
    }
    async all_board_sections(callback, request, options) {
        return this.authStream(callback, 'GET', '/board_sections', { fields: request.fields, sorts: request.sorts }, null, options);
    }
    async all_boards(callback, fields, options) {
        return this.authStream(callback, 'GET', '/boards', { fields }, null, options);
    }
    ...
    async board(callback, board_id, fields, options) {
        return this.authStream(callback, 'GET', `/boards/${board_id}`, { fields }, null, options);
    }
    async board_item(callback, board_item_id, fields, options) {
        return this.authStream(callback, 'GET', `/board_items/${board_item_id}`, { fields }, null, options);
    }
    async board_section(callback, board_section_id, fields, options) {
        return this.authStream(callback, 'GET', `/board_sections/${board_section_id}`, { fields }, null, options);
    }
    ...
    async create_board(callback, body, fields, options) {
        return this.authStream(callback, 'POST', '/boards', { fields }, body, options);
    }
    async create_board_item(callback, body, fields, options) {
        return this.authStream(callback, 'POST', '/board_items', { fields }, body, options);
    }
    async create_board_section(callback, body, fields, options) {
        return this.authStream(callback, 'POST', '/board_sections', { fields }, body, options);
    }
    ...
    async create_embed_url_as_me(callback, body, options) {
        return this.authStream(callback, 'POST', '/embed/token_url/me', null, body, options);
    }
    ...
    async delete_board(callback, board_id, options) {
        return this.authStream(callback, 'DELETE', `/boards/${board_id}`, null, null, options);
    }
    async delete_board_item(callback, board_item_id, options) {
        return this.authStream(callback, 'DELETE', `/board_items/${board_item_id}`, null, null, options);
    }
    async delete_board_section(callback, board_section_id, options) {
        return this.authStream(callback, 'DELETE', `/board_sections/${board_section_id}`, null, null, options);
    }
    ...
    async search_boards(callback, request, options) {
        return this.authStream(callback, 'GET', '/boards/search', {
            title: request.title,
    ...
    async update_board(callback, board_id, body, fields, options) {
        return this.authStream(callback, 'PATCH', `/boards/${board_id}`, { fields }, body, options);
    }
    async update_board_item(callback, board_item_id, body, fields, options) {
        return this.authStream(callback, 'PATCH', `/board_items/${board_item_id}`, { fields }, body, options);
    }
    async update_board_section(callback, board_section_id, body, fields, options) {
        return this.authStream(callback, 'PATCH', `/board_sections/${board_section_id}`, { fields }, body, options);
    }
