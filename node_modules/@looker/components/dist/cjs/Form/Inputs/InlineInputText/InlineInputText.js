...
exports.InlineInputTextInternal = react_1.forwardRef((_a, ref) => {
    ...
    return (react_1.default.createElement("div", { className: className, "data-testid": "inlineInputText" },
        react_1.default.createElement(Input, Object.assign({ onChange: handleChange, underlineOnlyOnHover: underlineOnlyOnHover, value: displayValue, ref: ref }, pick_1.default(props, InputProps_1.inputPropKeys))),
        react_1.default.createElement(VisibleText, { displayValue: displayValue }, displayValue || placeholder)));
});
exports.InlineInputTextInternal.displayName = 'InlineInputTextInternal';
const Input = styled_components_1.default.input.attrs({ type: 'text' }).withConfig({ displayName: "Input", componentId: "sc-19i2cyc" }) `
  ...
  width: 100%;
`;
const VisibleText = styled_components_1.default.div.withConfig({ displayName: "VisibleText", componentId: "sc-1ry5o74" }) `
  color: ${({ displayValue, theme }) => displayValue
    ? theme.colors.palette.charcoal900
    : theme.colors.palette.charcoal400};
`;
exports.InlineInputText = styled_components_1.default(exports.InlineInputTextInternal).withConfig({ displayName: "InlineInputText", componentId: "sc-aoxz2y" }) `
