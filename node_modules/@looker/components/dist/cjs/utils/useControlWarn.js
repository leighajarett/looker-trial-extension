...
function warnComponentControl(componentName, controllingProps) {
    const propsText = controllingProps.slice(0, -1).join(',') +
        ' and ' +
...
function useControlWarn({ isControlledCheck, name, controllingProps, }) {
    const { current: isControlled } = react_1.useRef(isControlledCheck());
