...
export declare enum ComboboxActionType {
    CLEAR = "CLEAR",
    CHANGE = "CHANGE",
...
export declare function useReducerMachine(initialData: ComboboxData): [ComboboxState, ComboboxData, ComboboxTransition];
export declare function useReducerMultiMachine(initialData: ComboboxMultiData): [ComboboxState, ComboboxMultiData, ComboboxTransition<ComboboxMultiActionPayload>];
