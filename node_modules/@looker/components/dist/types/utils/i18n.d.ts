...
export declare const formatDateString: (date?: Date | undefined, locale?: Locales) => string;
export declare const formatYear: (date: Date) => number;
export declare const parseDateFromString: (value: string, locale: Locales) => false | Date;
