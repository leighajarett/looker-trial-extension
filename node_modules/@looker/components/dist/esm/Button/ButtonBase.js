...
export const buttonCSS = css `
  ...
  ${space}
`;
const ButtonOuter = styled.button.withConfig({ displayName: "ButtonOuter", componentId: "sc-96uw1q" }) `
  ${buttonCSS}
...
export const ButtonBase = styled(ButtonJSX).withConfig({ displayName: "ButtonBase", componentId: "sc-rxxo6j" }) `
  ${buttonIcon}
`;
