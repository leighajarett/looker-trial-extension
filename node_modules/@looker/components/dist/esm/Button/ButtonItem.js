...
export const ButtonItemLabelText = styled.span.withConfig({ displayName: "ButtonItemLabelText", componentId: "sc-1xq0wje" }) ``;
export const ButtonItemLabel = styled.label.withConfig({ displayName: "ButtonItemLabel", componentId: "sc-11kd6rb" }) `
  cursor: pointer;
  display: inline-flex;
  align-items: center;
  ...
  ${typography}
`;
const ButtonInput = styled.input.withConfig({ displayName: "ButtonInput", componentId: "sc-15kavqs" }) `
  display: none;
`;
const ButtonItemComponent = forwardRef((_a, ref) => {
    ...
    return (React.createElement(ButtonItemLabel, Object.assign({ disabled: disabled, htmlFor: id, fontFamily: "brand", py: "small", selected: showSelected }, props),
        React.createElement(ButtonInput, { type: props.type, disabled: disabled, name: name, id: id, onChange: handleChange, checked: showSelected, value: value, ref: ref }),
        React.createElement(ButtonItemLabelText, null, children)));
});
ButtonItemComponent.displayName = 'ButtonItemComponent';
export const ButtonItem = styled(ButtonItemComponent).withConfig({ displayName: "ButtonItem", componentId: "sc-188p7i8" }) ``;
