...
export const MenuSearch = (_a) => {
    ...
    return (React.createElement(HotKeys, { keyMap: { MOVE_DOWN: 'down', MOVE_UP: 'up' }, handlers: {
        ...
        React.createElement(ObserveKeys, { except: [], only: ['down', 'up'] },
            React.createElement(InputSearch, Object.assign({ hideSearchIcon: true, borderRadius: 0, border: "none", borderBottom: `1px solid ${palette.charcoal200}`, width: "100%", p: "large", height: "auto" }, props)))));
};
