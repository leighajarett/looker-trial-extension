...
export const MenuGroupLabel = (_a) => {
    ...
    return (React.createElement(MenuGroupLabelWrapper, { renderBoxShadow: !isLabelShimVisible },
        ...
        React.createElement(Heading, Object.assign({ fontSize: fontSize || 'small', as: "h2", px: "medium", py: "xsmall", fontWeight: "semiBold", style: labelStyles }, props), labelContent)));
};
const MenuGroupLabelWrapper = styled.div.withConfig({ displayName: "MenuGroupLabelWrapper", componentId: "sc-uh69j4" }) `
  ${color}
