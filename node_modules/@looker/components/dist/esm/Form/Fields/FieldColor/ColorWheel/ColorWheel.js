...
const ColorWheelWrapper = styled.div.withConfig({ displayName: "ColorWheelWrapper", componentId: "sc-mvegwn" }) `
  position: relative;
  width: ${({ size }) => size}px;
  height: ${({ size }) => size}px;
`;
const Canvas = styled.canvas.withConfig({ displayName: "Canvas", componentId: "sc-g7rz2m" }) `
  position: absolute;
  left: 0;
  top: 0;
`;
