...
const getBannerIntentStyling = (intent) => {
    ...
    switch (intent) {
        case 'warning':
            ...
            bannerTypeStyling.icon = (React.createElement(Icon, Object.assign({}, iconProps, { name: "Warning", color: "palette.yellow500" })));
            bannerTypeStyling.accessibilityLabel = 'Warning';
            break;
        case 'info':
            bannerTypeStyling.bg = 'palette.blue100';
            bannerTypeStyling.icon = (React.createElement(Icon, Object.assign({}, iconProps, { name: "CircleInfo", color: "palette.blue400" })));
            bannerTypeStyling.accessibilityLabel = 'Info';
            break;
        case 'error':
            bannerTypeStyling.bg = 'palette.red100';
            bannerTypeStyling.icon = (React.createElement(Icon, Object.assign({}, iconProps, { name: "Warning", color: "palette.red600" })));
...
export const Banner = forwardRef((props, ref) => {
    ...
    return (React.createElement(Flex, Object.assign({ ref: ref, flex: "auto" }, bannerIntentStyling, { borderRadius: "medium", m: "small", py: "xsmall", px: "small", alignItems: "center", "aria-live": "polite", role: "status" }, typeAndSpaceProps),
        icon,
        React.createElement(VisuallyHidden, null, accessibilityLabel),
        React.createElement(Box, { flex: "auto" }, children),
        canDismiss && (React.createElement(IconButton, { ml: "auto", style: { padding: '1px' }, onClick: onDismiss, hoverStyle: { background: 'none' }, icon: "Close", size: "small", label: `Dismiss ${intent}`, "aria-hidden": true }))));
});
