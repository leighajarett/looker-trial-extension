...
const Styled = styled.div.withConfig({ displayName: "Styled", componentId: "sc-2fq1a5" }) `
  ${reset}
  ${color}
  ${space}
  ${layout}
...
export const Icon = styled(IconFactory).withConfig({ displayName: "Icon", componentId: "sc-4sb3c4" }) ``;
