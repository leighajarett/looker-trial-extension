export function getWindowedListBoundaries({ buffer = 5, containerHeight, containerScrollPosition, enabled = true, itemHeight, length, }) {
    if (!enabled)
        return { end: length - 1, start: 0 };
    ...
    const bottom = Math.ceil((containerHeight + containerScrollPosition) / itemHeight);
    return {
