export declare const defaultApiVersion = "3.1";
export declare const lookerVersion = "7.2";
export declare const apiVersion = "4.0";
 ...
 */
export declare const unquote: (value: string | null | undefined) => string;
/**
