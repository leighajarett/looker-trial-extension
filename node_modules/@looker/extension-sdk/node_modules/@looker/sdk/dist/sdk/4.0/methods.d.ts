...
export declare class Looker40SDK extends APIMethods {
     ...
     */
    datagroup_id: number, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IDatagroup, IError>>;
    /**
     ...
     */
    integration_id: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IDataActionForm, IValidationError | IError>>;
    /**
     ...
     */
    legacy_feature_id: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<ILegacyFeature, IError>>;
    /**
     ...
     * @param {string} integration_id Id of Integration
     */
    integration_id: string, options?: Partial<ITransportSettings>): Promise<import("../../rtl/transport").SDKResponse<IIntegrationTestResult, IValidationError | IError>>;
    /**
