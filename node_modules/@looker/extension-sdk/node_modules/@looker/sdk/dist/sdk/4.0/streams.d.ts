...
export declare class Looker40SDKStream extends APIMethods {
     ...
     */
    body: Partial<ICreateFolder>, options?: Partial<ITransportSettings>): Promise<IFolder>;
    /**
     ...
     */
    body: Partial<ICreateSpace>, options?: Partial<ITransportSettings>): Promise<ISpace>;
    /**
     ...
     */
    body: Partial<ISqlQueryCreate>, options?: Partial<ITransportSettings>): Promise<ISqlQuery>;
    /**
     ...
     */
    body: Partial<IEmbedSsoUrlParams>, options?: Partial<ITransportSettings>): Promise<IEmbedSsoUrl>;
    /**
     * ### Create a theme
     *
     ...
     */
    dashboard_lookml(callback: (readable: Readable) => Promise<IDashboardLookml>, 
    /**
     * @param {string} dashboard_id Id of dashboard
     */
    dashboard_id: string, options?: Partial<ITransportSettings>): Promise<IDashboardLookml>;
    /**
     ...
     */
    datagroup_id: number, options?: Partial<ITransportSettings>): Promise<IDatagroup>;
    /**
     ...
     */
    integration_id: string, options?: Partial<ITransportSettings>): Promise<IDataActionForm>;
    /**
     ...
     */
    legacy_feature_id: string, options?: Partial<ITransportSettings>): Promise<ILegacyFeature>;
    /**
     ...
     */
    body: Partial<IDataActionRequest>, options?: Partial<ITransportSettings>): Promise<IDataActionResponse>;
    /**
     ...
     */
    query_task_results(callback: (readable: Readable) => Promise<string>, 
    /**
     * @param {string} query_task_id ID of the Query Task
     */
    query_task_id: string, options?: Partial<ITransportSettings>): Promise<string>;
     ...
     * @param {string} integration_id Id of Integration
     */
    integration_id: string, options?: Partial<ITransportSettings>): Promise<IIntegrationTestResult>;
    /**
     ...
     */
    body: Partial<IUpdateFolder>, options?: Partial<ITransportSettings>): Promise<IFolder>;
    /**
     ...
     */
    body: Partial<IUpdateSpace>, options?: Partial<ITransportSettings>): Promise<ISpace>;
    /**
